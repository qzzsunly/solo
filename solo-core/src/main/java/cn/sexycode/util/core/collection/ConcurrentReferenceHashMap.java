...
public class ConcurrentReferenceHashMap<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V> {
            ...
            if (ref != null || (needsResize && allowResize)) {
                ...
                try {
                    ...
                    Reference<K, V>[] restructured = (resizing
                            ? createReferenceArray(restructureSize)
                            : this.references);
                            ...
                            if (!toPurge.contains(ref)) {
                                ...
                                if (entry != null) {
                                    ...
                                    restructured[index] = this.referenceManager
                                            .createReference(entry, ref.getHash(), restructured[index]);
                                }
                            }
                            ref = ref.getNext();
                        }
    ...
    protected static final class Entry<K, V> implements Map.Entry<K, V> {
        ...
        public final boolean equals(Object other) {
            ...
            return (ObjectUtils.nullSafeEquals(getKey(), otherEntry.getKey()) && ObjectUtils
