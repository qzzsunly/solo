...
public class JarFileBasedArchiveDescriptor extends AbstractArchiveDescriptor {
     ...
     */
    public JarFileBasedArchiveDescriptor(ArchiveDescriptorFactory archiveDescriptorFactory, URL archiveUrl,
            String entry) {
                    ...
                    try (final InputStream is = new BufferedInputStream(jarFile.getInputStream(zipEntry));
                        ...
                        while (subZipEntry != null) {
                            if (!subZipEntry.isDirectory()) {
                                ...
                                final InputStream inputStreamAccess = buildByteBasedInputStreamAccess(name,
                                        jarInputStream);
                                ...
                                final ArchiveEntry entry = new ArchiveEntry() {
                                    ...
                                    @Override
                                    public InputStream getStreamAccess() {
